...
@pytest.mark.parametrize(
    ...
    [
        ...
        (UserRole.MEMBER, "group.member.edit", False),
        (UserRole.GROUP_ADMIN, "group.member.edit", True),
        (UserRole.OWNER, "group.member.edit", True),
        (UserRole.MEMBER, "group.member.read", True),
        (UserRole.MEMBER, "interaction.poke", True),
        (UserRole.GROUP_ADMIN, "interaction.poke", True),
        (UserRole.OWNER, "interaction.poke", True),
